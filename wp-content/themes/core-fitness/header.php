  ...
  <div id="header">
        ...
        <div class="row">
          <div class="top-contact col-md-3 col-xs-12 col-sm-3">
            <?php if( get_theme_mod( 'the_wp_fitness_contact_corporate','' ) != '') { ?>
              <span class="call"><i class="fa fa-phone" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('the_wp_fitness_contact_corporate',__('520-565-5896','core-fitness') )); ?></span>
             <?php } ?>
          </div>   
          <div class="top-contact col-md-3 col-xs-12 col-sm-3">
            <?php if( get_theme_mod( 'the_wp_fitness_email_corporate','' ) != '') { ?>
              <span class="email_corporate"><i class="fa fa-envelope" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('the_wp_fitness_email_corporate',__('example.com','core-fitness')) ); ?></span>
            <?php } ?>
          </div>
    ...
    <div class="menu-sec">
      <div class="container menu-bg">
        ...
        <div class="toggle"><a class="toggleMenu" href="#"><?php esc_html_e('Menu','core-fitness'); ?></a></div>
      </div>
    </div>
  </div>
