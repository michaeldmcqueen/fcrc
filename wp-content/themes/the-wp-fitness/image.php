                            ...
                            <div class="entry-content">
                                ...
                                <div class="entry-attachment">
                                    <div class="attachment">
                                        <?php the_wp_fitness_the_attached_image(); ?>
                                    </div>
                                ...
                                <?php
                                    the_content();
                                    wp_link_pages( array(
                                        'before' => '<div class="page-links">' . __( 'Pages:', 'the-wp-fitness' ),
                                        'after'  => '</div>',
                                    ) );
                                ?>
                            </div>    
                            <?php edit_post_link( __( 'Edit', 'the-wp-fitness' ), '<footer class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                        </article>    
                        <?php
