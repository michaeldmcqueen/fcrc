				...
				<div class="col-md-8 col-sm-8" id="wrapper">
					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						if ( is_singular( 'attachment' ) ) {
							...
							the_post_navigation( array(
								'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'the-wp-fitness' ) . '</span> ' .
									'<span class="screen-reader-text">' . __( 'Next post:', 'the-wp-fitness' ) . '</span> ' .
									'<span class="post-title">%title</span>',
								'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'the-wp-fitness' ) . '</span> ' .
