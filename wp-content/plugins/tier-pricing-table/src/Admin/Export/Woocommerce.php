<?php namespace TierPricingTable\Admin\Export;
...
class Woocommerce {
	...
	public function __construct() {
		add_filter( 'woocommerce_product_export_column_names', [ $this, 'addExportColumn' ], 1, 10 );
		add_filter( 'woocommerce_product_export_product_default_columns', [ $this, 'addExportColumn' ], 1, 10 );
		add_filter( 'woocommerce_product_export_product_column_tiered_price_fixed', [ $this, 'addExportFixedData' ], 10,
			2 );
		add_filter( 'woocommerce_product_export_product_column_tiered_price_percentage',
			[ $this, 'addExportPercentageData' ], 10, 2 );
